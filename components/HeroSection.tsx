    ...
    <section className="relative h-[80vh] sm:h-[70vh] flex items-center justify-center">
      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        <div className="max-w-3xl mx-auto space-y-4 sm:space-y-6">
          ...
          <Link
            href="/properties"
            className="inline-block mt-4 sm:mt-6 px-6 py-3 bg-gradient-to-r from-yellow-500 to-yellow-800 text-black font-semibold rounded-full shadow-lg hover:shadow-xl transition-all"
          >
            Explore Properties
          </Link>
        </div>
